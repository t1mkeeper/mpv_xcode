...
#define HAVE_VIDEOTOOLBOX_HWACCEL 1
...
#define CONFIGURATION "./waf configure --enable-libmpv-shared --disable-libass --prefix=/Users/yuelei/Desktop/openGitProj/mpv/build/install --disable-swift --disable-cplayer"
#define MPV_CONFDIR "/Users/yuelei/Desktop/openGitProj/mpv/build/install/etc/mpv"
#define FULLCONFIG "apple-remote asm atomics bsd-fstatfs build-date cocoa coreaudio cplugins debug-build drmprime dummy-osd fchmod ffmpeg gl gl-cocoa glob glob-posix gnuc gpl iconv jpeg libaf libav-any libavcodec libavdevice libdl libm libmpv-shared macos-touchbar optimize osx-thread-name plain-gl posix posix-or-mingw posix-spawn posix-spawn-native pthreads stdatomic videotoolbox-gl videotoolbox-hwaccel zlib"
